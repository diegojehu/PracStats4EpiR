...
\hypersetup{
  pdftitle={Processing \& Visualising Epidemiological Data},
...
\title{Processing \& Visualising Epidemiological Data}
...
\includegraphics{01_L2_process-viz-epi-data_files/figure-beamer/pressure-1.pdf}

\animategraphics[,controls,loop]{1}{01_L2_process-viz-epi-data_files/figure-beamer/unnamed-chunk-1-}{1}{2}
\end{frame}
