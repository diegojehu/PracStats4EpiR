...
**Question 2.1.1** Fill in the table bellow, with answers to 3 decimal places:
...
**Question 3.1.1**: Complete the following table and interpret
the results.
...
Plot a graph to illustrate how power changes with sample size (200 to 2000), for
